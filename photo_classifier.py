...
def disp_sample_images(train_loader, classes):
...
def prep_data():
    ...
    train_set = torchvision.datasets.CIFAR10(download=True, root='./data',
    ...
    test_set = torchvision.datasets.CIFAR10(download=True, root='/.data',
...
def sample_guesses():
    ...
    print('Predicted: ',
          ' '.join('%5s' % classes[index[j]] for j in range(10)))
